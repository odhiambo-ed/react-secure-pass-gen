...
> A simple password generator built with React that allows users to generate secure passwords with customizable options. The app includes a progress bar to visually represent password strength, helping users create strong passwords easily.
...
```
To get a clone of the project, run `https://github.com/odhiambo-ed/react-secure-pass-gen.git`
```

```
cd /react-secure-pass-gen
```
...
Feel free to check the [issues page]https://github.com/odhiambo-ed/react-secure-pass-gen/issues)
